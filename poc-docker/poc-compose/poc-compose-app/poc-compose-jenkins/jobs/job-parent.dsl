...
job("poc-app-maven-with-params-autogenerated") {
  ...
  parameters {
    ...
    stringParam('FILENAME', defaultValue = 'poc-app-maven-simple', description = 'Arfifact filename')
  ...
  steps {
    ...
    shell('''
      ...
      if [ $FLAG = true ]; then
        echo "***** Renaming jar *****"
        mv target/poc-app-maven-basic-1.0.0.jar target/${FILENAME}-${VERSION}.jar
      fi
    ''')
  }
